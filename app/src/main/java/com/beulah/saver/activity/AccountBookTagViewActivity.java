...
import com.beulah.saver.adapter.DrawerTagChooseGridViewAdapter;
import com.beulah.saver.adapter.TagViewFragmentAdapter;
...
public class AccountBookTagViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewPager.getPagerTitleStrip().setTypeface(RupayeUtil.typefaceLatoLight, Typeface.NORMAL);
            ...
            mViewPager.setMaterialViewPagerListener(new MaterialViewPager.Listener() {
                ...
                public HeaderDesign getHeaderDesign(int page) {
                    return HeaderDesign.fromColorAndUrl(
                            RupayeUtil.GetTagColor(RecordManager.TAGS.get(page).getId()),
                            RupayeUtil.GetTagUrl(RecordManager.TAGS.get(page).getId()));
                }
            });
        } else {
            mViewPager.setMaterialViewPagerListener(new MaterialViewPager.Listener() {
