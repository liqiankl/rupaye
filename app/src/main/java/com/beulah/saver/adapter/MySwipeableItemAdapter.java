...
import com.beulah.saver.ui.SwipeableItemOnClickListener;
...
public class MySwipeableItemAdapter
    ...
    private List<RupayeRecord> records;
    ...
    public MySwipeableItemAdapter(Context inContext, List<RupayeRecord> records, final OnItemDeleteListener onItemDeleteListener, OnItemClickListener onItemClickListener) {
        mContext = inContext;
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        RupayeRecord record = records.get(tPosition);
        holder.tagImage.setImageResource(
                RupayeUtil.GetTagIcon(record.getTag()));
        ...
        holder.money.setTextColor(ContextCompat.getColor(RupayeApplication.getAppContext(), R.color.my_blue));
