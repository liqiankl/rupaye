...
public class TagDraggableItemAdapter
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.tagImage.setImageResource(RupayeUtil.GetTagIcon(tags.get(position).getId()));
        holder.tagName.setText(RupayeUtil.GetTagName(tags.get(position).getId()));
        holder.tagName.setTypeface(RupayeUtil.typefaceLatoLight);
        ...
        if (((dragState & Draggable.STATE_FLAG_IS_UPDATED) != 0)) {
            ...
            if ((dragState & Draggable.STATE_FLAG_IS_ACTIVE) != 0) {
                ...
                RupayeUtil.clearState(holder.mContainer.getForeground());
