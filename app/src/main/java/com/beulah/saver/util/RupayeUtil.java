...
import com.beulah.saver.db.DBHelper;
...
// Todo make RupayeUtil singleton
// Todo floating labels in english

public class RupayeUtil {
    ...
    public static RupayeRecord backupRupayeRecord;
...
//            R.drawable.sum_header_pie
    ...
    public static void init(Context context) {
        ...
        MY_BLUE = ContextCompat.getColor(RupayeApplication.getAppContext(), R.color.my_blue);
    }

    public static Typeface GetTypeface() {
        if (typefaceLatoLight == null) init(RupayeApplication.getAppContext());
    ...
    public static String GetTodayViewTitle(int fragmentPosition) {
        return RupayeApplication.getAppContext().getString(TODAY_VIEW_TITLE[fragmentPosition]);
    }
    ...
    public static String GetAxisDateName(int type, int position) {
        switch (type) {
            ...
            case Calendar.DAY_OF_WEEK:
                if (WEEK_START_WITH_SUNDAY) return RupayeApplication.getAppContext().getResources()
                        .getString(WEEKDAY_SHORT_START_ON_SUNDAY[position + 1]);
                else return RupayeApplication.getAppContext().getResources()
                        .getString(WEEKDAY_SHORT_START_ON_MONDAY[position + 1]);
            case Calendar.DAY_OF_MONTH:
                return (position + 1) + "";
            case Calendar.MONTH:
                return RupayeApplication.getAppContext().getResources()
    ...
    public static String GetMonthShort(int i) {
        return RupayeApplication.getAppContext().getResources().getString(MONTHS_SHORT[i]);
    }

    public static String GetMonth(int i) {
        return RupayeApplication.getAppContext().getResources().getString(MONTHS[i]);
    }
    ...
    public static int GetTagColor(int tag) {
        return ContextCompat.getColor(RupayeApplication.getAppContext(), TAG_COLOR[tag + 3]);
    }

    public static Drawable GetTagDrawable(int tagId) {
        return ContextCompat.getDrawable(
                RupayeApplication.getAppContext(), TAG_DRAWABLE[tagId + 3]);
    }
    ...
    public static Drawable GetTagIconDrawable(int tagId) {
        return ContextCompat.getDrawable(
                RupayeApplication.getAppContext(), TAG_ICON[tagId + 2]);
    }

    public static String GetTagName(int tagId) {
        return RupayeApplication.getAppContext().getResources().getString(TAG_NAME[tagId + 2]);
    }
    ...
    public static int getStatusBarHeight() {
        int result = 0;
        int resourceId = RupayeApplication.getAppContext()
                .getResources().getIdentifier("status_bar_height", "dimen", "android");
        if (resourceId > 0) {
            result = RupayeApplication.getAppContext()
    ...
    public static int dpToPx(int dp) {
        DisplayMetrics displayMetrics = RupayeApplication.getAppContext().getResources().getDisplayMetrics();
    ...
    public static String GetCurrentVersion() {
        return "Rupaye V" + RupayeApplication.VERSION / 100 + "." + RupayeApplication.VERSION % 100 / 10 + "." + RupayeApplication.VERSION % 10;
    }
    ...
    public static String GetRecordDatabasePath(Context context) {
        ...
        if (BuildConfig.DEBUG) Log.d("Rupaye", "Get record database path " + databasePath);
        return databasePath;
    }
...
//        if (file.exists()) file.delete();
    ...
    private static RupayeUtil ourInstance = new RupayeUtil();

    public static RupayeUtil getInstance() {
        if (ourInstance == null || typefaceLatoLight == null || typefaceLatoHairline == null) {
            ourInstance = new RupayeUtil();
            init(RupayeApplication.getAppContext());
        }
        return ourInstance;
    }
