...
public class ShowActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int iconOffsetX = RupayeUtil.getInstance().dpToPx(28);
        int iconOffsetY = RupayeUtil.getInstance().dpToPx(28);
        ...
        ((TextView)findViewById(R.id.text_0)).setTypeface(RupayeUtil.getInstance().typefaceLatoLight);
        ...
        for (int i = 0; i < 5; ++i) {
            SliceValue sliceValue = new SliceValue((float) Math.random() * 30 + 15, ContextCompat.getColor(RupayeApplication.getAppContext(), R.color.white));
        ...
        for (int i = 0; i < 1; ++i) {
            ...
            aLine.setColor(ContextCompat.getColor(RupayeApplication.getAppContext(), R.color.white));
        ...
        for (int i = 0; i < 5; ++i) {
            ...
            for (int j = 0; j < 1; ++j) {
                subcolumnValues.add(new SubcolumnValue((float) Math.random() * 50f + 5, ContextCompat.getColor(RupayeApplication.getAppContext(), R.color.white)));
            }
        ...
        sc7.startToPosition(size.x / 2 - RupayeUtil.getInstance().dpToPx(140), size.y * 8 / 9 - RupayeUtil.getInstance().dpToPx(140) + size.y);
        ...
        ((TextView)findViewById(R.id.text_1)).setTypeface(RupayeUtil.getInstance().typefaceLatoLight);
        ...
        sc9.startToPosition(size.x / 2 - RupayeUtil.getInstance().dpToPx(100) + size.x, size.y / 7);
        ...
        sc10.startToPosition(size.x / 2 - size.x, size.y * 6 / 7 - RupayeUtil.getInstance().dpToPx(100));
        ...
        ((TextView)findViewById(R.id.text_2)).setTypeface(RupayeUtil.getInstance().typefaceLatoLight);
        ...
        ((TextView)findViewById(R.id.text_3)).setTypeface(RupayeUtil.getInstance().typefaceLatoLight);
                ...
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        ...
                        viewPagerLayoutParams.topMargin
                                = getStatusBarHeight() + RupayeUtil.getToolBarHeight(mContext) / 2;
                ...
                if (RupayeUtil.ClickButtonDelete(position)) {
                    ...
                    if (againPassword.length() == 4) {
                        ...
                        if (againPassword.equals(newPassword)) {
                            ...
                            RupayeFragmentManager.passwordChangeFragment[CURRENT_STATE - 1].init();
