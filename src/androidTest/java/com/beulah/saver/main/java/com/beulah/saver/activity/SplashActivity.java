...
public class SplashActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appName.setTypeface(RupayeUtil.getInstance().typefaceLatoLight);
        loadingText = (TextView)findViewById(R.id.loading_text);
        loadingText.setTypeface(RupayeUtil.getInstance().typefaceLatoLight);
    ...
    private void startCircularReveal() {
        ...
        int cx = location[0] + RupayeUtil.dpToPx(24);
        int cy = location[1] + RupayeUtil.dpToPx(24);
        ...
        animator.addListener(new SupportAnimator.AnimatorListener() {
            ...
            public void onAnimationEnd() {
                Log.d("Rupaye", "Showing animation completed");
    ...
    public class InitData extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            CrashReport.initCrashReport(RupayeApplication.getAppContext(), "900018935", false);
        ...
        protected void onPostExecute(String result) {
            Log.d("Rupaye", "Loading Data completed");
