...
import com.beulah.saver.adapter.MonthViewRecyclerViewAdapter;
...
public class MonthViewFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (!IS_EMPTY) {
            ...
            Calendar leftRange = RupayeUtil.GetThisWeekLeftRange(monthStart);
            Calendar rightRange = RupayeUtil.GetThisWeekRightRange(monthEnd);
