...
import com.beulah.saver.adapter.RecordCheckDialogRecyclerViewAdapter;
...
public class RecordCheckDialogFragment extends DialogFragment implements RecordCheckDialogRecyclerViewAdapter.OnItemClickListener {
    ...
    public RecordCheckDialogFragment(Context context, List<RupayeRecord> list, String title) {
        this.list = list;
        this.title = title;
        mContext = context;
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        alert.setOnShowListener(new DialogInterface.OnShowListener() {
            ...
            public void onShow(DialogInterface dialog) {
                ...
                btnPositive.setTypeface(RupayeUtil.typefaceLatoLight);
            }
        });
    ...
    public void onItemClick(View view, int position) {
        ...
        dialog = new MaterialDialog.Builder(mContext)
                .icon(RupayeUtil.GetTagIconDrawable(list.get(position).getTag()))
        ...
        date.setText(RupayeUtil.GetCalendarStringRecordCheckDialog(mContext, list.get(position).getCalendar()));
    }
}
